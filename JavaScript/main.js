...
window.addEventListener("DOMContentLoaded", () => {
        ...
        importarChartJS(() => {
            ...
            var chart = new Chart(grafica, {
                    ...
                    datasets: [
                        {
                            ...
                            // Se eliminó la propiedad "wid" incompleta que rompía el código
                            data: [
                ...
                options: {
                    ...
                    plugins: {
                        legend: {
                            position: 'top',    // Coloca las etiquetas arriba. Puedes usar 'bottom' si prefieres abajo en móviles
                        }
                    }
                }
            });
    ...
    function filtrarporfecha(fechaseleccionada){
        ...
        HistorialVehiculos.forEach(registrofecha => {

            if(registrofecha.FechaIngreso === fechaseleccionada){
                ingresodeldia += Number(registrofecha.TotalPagado);
            }
        });
        document.getElementById("informacionKPIS4").innerHTML = `<h2>Q${ingresodeldia.toFixed(2)}</h2>`;
    }
